...
public class DownloadBuilder {
    ...
    private boolean isSkipToDownLoadSuccess; //下载成功之后是否跳转到安装页面
...
//        downloadAPKPath = FileHelper.getDownloadApkCachePath();
    ...
    public boolean isSkipToDownLoadSuccess() {
        return isSkipToDownLoadSuccess;
    }

    public DownloadBuilder setSkipToDownLoadSuccess(boolean isSkip) {
        isSkipToDownLoadSuccess = isSkip;
        return this;
    }
